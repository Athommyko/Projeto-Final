...
public class App implements Runnable{
    ...
    public void run() {
        ...
        while (option > 0) {
            try {
                ...
                terminalService.showMessage("OPÇÂO INVÀLIDA DEVIDO À ERRO: %s".formatted(e.getMessage()));
                terminalService.showMessage("DIGITE UMA OPÇÂO VÀLIDA", 2000);
            }
        }
    ...
    private void showProductById() {
        try {
            ...
            terminalService.showMessage("OPERAÇÂO CANCELADA DEVIDO À ERRO: %s".formatted(ex.getMessage()));
        }
